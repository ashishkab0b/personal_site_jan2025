...
const projectsData = [
  {
    ...
    short_description: 'In this work, I seek to understand psychological mechanisms important for personalizing emotion regulation support to the individual and then using this understanding to develop LLM-based emotion regulation tools.',
