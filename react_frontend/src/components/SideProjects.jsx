...
const projectsData = [
  ...
  },
  {
    ...
    long_description: 'Ecological momentary assessment (EMA) is a research method that involves collecting data from participants in their natural environments. In affective science, where human experience is foundational, EMA is a critical tool in the toolbox. I built EMA Pingbot to help researchers build, deploy, and manage EMA studies more easily. The tool allows researchers to create studies, schedule surveys, and collect data from participants in a streamlined, user-friendly interface. EMA Pingbot offers two main advantages over competing products. First, it allows researchers to build EMA studies using whatever survey software they know and prefer, instead of forcing them into a proprietary system. Second, it offers API access meaning that researchers can build complex dependencies and rules in their study design which allows for limitless flexibility.',
