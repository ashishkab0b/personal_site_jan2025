...
export default function ResearchIntro() {
  ...
  >
    ...
    <Typography component="p">
      How do we build AI to support not only our immediate preferences, but also our long-term flourishing? The Greek concept of <span style={{ fontStyle: "italic" }}>eudaimonia</span> refers to the idea that the good life is one guided by purpose, lived in alignment with our values, and marked by continual growth toward the best version of ourselves. AI has profound potential to either support individuals in this endeavour or thwart their attempts to live a life eudaimonically. In my postdoctoral research, I am developing AI methods to support such eudaimonic living -- and trying to understand the ways in which AI can steer people off track. In one line of work, I am exploring how we can personalize AI to individuals' unique sets of interconnected beliefs, values, and goals to help them live more meaningful lives. I am also developing benchmarks to evaluate AI's ability to do so. In another line of work, I am investigating how AI can sometimes lead people into downward spirals of ill-being, by amplifying delusional beliefs or maladaptive goals. 
    </Typography>
