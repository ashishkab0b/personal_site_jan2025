...
export default function ResearchIntro() {
  ...
  >
    ...
    <Typography component="p">
    In my postdoc, I am extending these ideas beyond the domain of emotion to develop methods for personalizing general purpose LLMs based on people's unique cognitive and affective characteristics. I am also working on developing new evaluation benchmarks for assessing the the ability of LLMs to personalize responses to individual users.
    </Typography>
    </Box>
    </Box>
